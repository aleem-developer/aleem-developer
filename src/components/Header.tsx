...
const Header: React.FC<HeaderProps> = ({ activeSection }) => {
  ...
  const scrollToSection = (href: string) => {
    ...
    setIsMenuOpen(false); // ✅ Auto close mobile menu after click
  };
  ...
  return (
    ...
    >
      <div className="w-full md:max-w-7xl md:mx-auto px-6 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/"
              className="hidden sm:flex items-center gap-1 px-2 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
           ...
           <button
            ...
            className="md:hidden p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      {/* Mobile dropdown */}
      {isMenuOpen && (
        <div className="md:hidden absolute inset-x-0 top-16 px-4 sm:px-2 lg:px-8">
